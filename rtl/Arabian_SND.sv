...
(
    input         reset,
    input         clk_12m,           // 12 MHz master clock
...
// 3 MHz (12/4) and 1.5 MHz for the AY (MAIN_OSC/4/2 = 12/8, arabian.cpp)
reg [2:0] div = 3'd0;
always_ff @(posedge clk_12m) begin
    div <= div + 3'd1;
end
wire cen_3m  = (div[1:0] == 2'd0);    // Every 4th clock
wire cen_1m5 = (div == 3'd0);         // Every 8th clock
